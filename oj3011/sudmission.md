...
```text
โจทย์นี้ต้องการผสมสีตามแม่สี ได้แก่ สีแดง(Red),สีเหลือง (Yellow)และสีน้ำเงิน(Blue)
โดยinputต้องมี2ตัว คือ ชื่อสีที่ต้องการผสม
output จะต้องเป็นชื่อสีที่ผสมแล้ว
ข้อจำกัด:ต้องนำแค่แม่สีที่กำหนดมาผสมเท่านั้น หากมีสีอื่นที่ไม่ใช่แม่สีมาผสม ให้ตอบว่า Error และตัวอักษรแรกสุดเป็นตัวใหญ่เสมอ
...
```text
Step 1: ดูรูปแบบของTestcasesว่าinput และ outputเป็นยังไง
Step 2: ใช้ if else ในการกำหนดว่า ถ้าinput Red กับ Blue ต้องprint Violetนะ
Step 3: ใช้ .capitalize() ในการกำหนดให้input มีตัวอักษรแรกสุดเป็นตัวใหญ่เสมอ ที่เหลือเป็นตัวเล็กหมด
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก ใช้if else ในการกำหนดว่าแม่สีผสมการแม่สีอีกอันนึกจะได้สีอะไร 
และถ้าเป็นสีอื่นที่ไม่ใช่แม่สีให้แสดงว่า Error แล้วถ้าเป็นแม่สีแต่เป็นสีเดียวกันกับสีแรก จะแสดงผลเป็นสีเดิม
...
```text
คอยอธิบาย โจทย์และโค้ดที่ฉันไม่เข้าใจ
