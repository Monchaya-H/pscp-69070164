...
```text
โจทย์นี้ต้องการระบุบชื่อของไพ่
Input:แต้มของไพ่และกลุ่มของไพ่
Output:แสดงชื่อของไพ่
Constraints: -
...
```text
Step 1: ใช้ตัวString Slicing lndexในกำหนดตำแหน่งของinput
Step 2: ใช้ if else กำหนดว่าชื่อของไพ่
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ การที่ใช้ String Slicing lndex เพื่อกำหนดว่าตัวย่อไหนเป็น แต้ม ตัวไหนเป็นกลุ่มของไพ่ และใช้ if else เพื่อบอกชื่อเต็มของแต้มแลพกลุ่มของไพ่
