...
```text
โจทย์นี้ต้องการนับสระภาษาอังกฤษ ว่ามนข้อความนั้นมี สระอีกตัว
Input:ข้อความ (ตัวอักษร)
Output:สระที่นับได้
Constraints: ไม่มี
...
```text
Step 1: ใช้ .lower() เพื่อที่จะทำให้ข้อความทั้งหมดเป็นตัวอักษรตัวเล็กทั้งหมด
Step 2: สร้าง listของตัวสระ
Step 3: ใช้ for loop ในการไล่ดูข้อความที่ input ว่ามีสระกี่ตัว
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ การใช้ for loopจะสามารถไล่ดูข้อความแต่ละตัวมาเป็นสระไหม โดยใช้ .count()เข้ามาช่วยหาว่ามีสระกี่ตัว ถ้าที่สระมากกว่า0 จะแสดงผลเป็น ตัวสระ : จำนวนสระที่มีอยู่ในข้อความ
...
```text
ถ้ามีสระมากกว่า10ตัว
```

Input:

```text
aaaaaeeeeeeeiiiiiiooooooooooopuuuuuaaaaeeeeiioouaaaaaaaaaeeeeeeeeeiiiiiiiiiiiooooooouuuuuuuuuuuu
