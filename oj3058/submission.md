...
```text
โจทย์นี้ต้องการทำโปรแกรมบอกจำนวนอิฐก้อนเล็กที่ต้องใช้สร้าง
Input1:จำนวนอิฐก้อนเล็ก
Input2:จำนวนอิฐก้อนใหญ่
Input3:จำนวนอิฐที่สร้างเสร็จ
Output:จำนวนอิฐก้อนเล็กที่ต้องใช้สร้าง
Constraints: อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนจะใช้อิฐก้อนเล็กเสมอ โดยต้องสร้างให้พอดีกับ goal นิ้ว ถ้าก้อนใหญ่มีเกิน ก็ให้ใช้เท่าที่ใช้ได้ แล้วนำก้อนเล็กมาโปะ ถ้าไม่สามารถสร้างได้ ตอบ -1 อิฐก้อนเล็กจะมีความยาว 1 นิ้ว อิฐก้อนใหญ่จะมีความยาว 5 นิ้ว
...
```text
Step 1: คำนวณหาอิฐก้อนใหญ่จากเป้าหมายหาร5
Step 2: คำนวณหาอิฐก้อนเล็ก โดยเอาคำตอบจากอิฐก้อนใหญ่ ลบ กับเป้าหมาย *5
Step 3: ใช้if else
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ ตอนที่คำนวณอิฐก้อนใหญ่ จะใช้ minเข้ามาหาค่าที่น้อยที่สุด เพราะจะได้ลบกับเป้าหมายได้ เพื่อหาจำนวนอิฐก้อนเล็ก และการใช้if else จะใช้ว่าถ้าตัวแปรอิฐก้อนเล็กมากกว่าเท่ากับ อิฐก้อนเล็กที่โจทย์กำหนด outputจะแสดงจำนวนของอิฐก้อนเล็กแต่ถ้าไม่ outputจะแสดง-1
...
```text
ช่วยอธิบายโค้ดที่ไม่เข้าใจ และช่วยไกด์โค้ด
