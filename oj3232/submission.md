...
```text
โจทย์นี้ต้องการรู้ว่าจะกระโดดกี่ครั้ง
Input:ระยะแรก และระยะสุดท้ายที่กบต้องกระโดด
Output:จํานวนครั้งกระโดด
Constraints: ถ้ากระโดดไม่ถึง แสดงผลเป็น -1 
...
```text
Step 1: ใช้ map เพื่อรวม int กับ input อยู่ด้วยกัน และใช้ .split() เพื่อแยก ระยะตอกแรก กับระยะตอนท้าย 
Step 2: ใช้ for loop ในการหาจำนวนที่กบกระโดด
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ รู้จำนวนรอบคือ ระยะทางที่กบจะต้องกระโดด เลยใช้ for loop แล้วใช้ break เมื่อไม่สามารถกระโดดได้แล้วออกจากลูปและจะแสดงผลเป็น -1 ถ้ายังกระโดดได้ ให้บวกสะสมไปเรื่อยๆจนถึงระยะทางสุดท้าย 
