...
```text
โจทย์นี้ต้องการรู้ว่าถูกรางวัลหรือไม่
Input 1:เป็นผลการออกรางวัลสลากกินแบ่ง
Input 2:เป็นหมวดตัวอักษร และ หมายเลขสลากที่ซื้อ
Output:แสดงเงินรางวัลที่ได้รับ
Constraints: ต้องแสดงรางวัลสูงสุดเพียงรางวัลเดียว ถ้าไม่ถูกรางวัล ให้แสดงผลลัพธ์เป็น 0
...
```text
Step 1: การใช้ input 2 ตัวโดย input ตัวที่ 1 คือ เลขที่ออกผลสลากกินแบ่ง และ input ตัวที่ 2 คือ เลขสลากกินแบ่นที่ซื้อมา
Step 2: และใช้ if else ในการกำหนดเงินรางวัล และจำนวนตัวเลที่ถูกรางวัล
Step 3: ถ้าไม่ถูกเลย จะไม่ได้รางวัล ให้ตอบ 0 บาท
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ รู้จำนวนของหลักของinput และสามารถใช้ String Slicing lndex เพื่อกำหนดว่า ถ้าถูกเลขท้าย 2 ตัวจะได้เงินรางวัล 1000 บาท
