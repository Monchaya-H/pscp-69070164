...
Input1:จำนวนA
Input2:จำนวนB
Input3:จำนวนนับ d (ตัวหาร)
Input4:จํานวนนับ r (เศษ) 
...
```text
Step 1: ใช้ loop ในการใส่ช่วง AกับB
Step 2: หาเศษในช่วง AกับB ให้เท่ากับ r ตัวเศษที่inputเข้ามา
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ การใช้ for loopหาช่วง AกับB เพื่อที่จะหาเศษในช่วง AกับB โดยการ % d ถ้าเศษที่หามาเท่ากับ r ที่inputเข้ามา ตัวคำตอบก็จะบวก 1 และoutputออกมาจะเป็นไปตามที่โจทย์กำหนด
...
```text
ช่วยสอนการใช้งานของfor loop และช่วยไกด์โค้ด
