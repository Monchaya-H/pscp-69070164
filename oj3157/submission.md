...
```text
โจทย์นี้ต้องการหาคะแนนรวมสุดท้าย
Input1:เป็นตัวเลข(จำนวนเต็ม)
Input2:เป็นสัญลักษณ์ (+,-)
Output:คะแนนรวมสุดท้าย
Constraints: + เพิ่ม10คะแนน
- ลด5คะแนน
...
```text
Step 1: ใส่ input เป็นจำนวนเต็ม
Step 2: ใช้ for loop กำหนดจำนวนของสัญลักษณ์ ว่ามีจำนวนเท่าไร
Step 3: ใช้ if elif ใน loop เพื่อกำหนดว่า ถ้าเป็น + คะแนนต้องเพิ่ม 10คะแนน แต่ถ้าเป็น - คะแนนต้องลด5คะแนน
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ การใช้for loop เพื่อกำหนดจำนวนสัญลักษณ์ จะตัว inputตัวแรก ใน loop ใช้ if elifถ้าเป็น + คะแนนต้องเพิ่ม 10คะแนน แต่ถ้าเป็น - คะแนนต้องลด5คะแนน และจะได้คะแนนรวมสุดท้าย
...
```text
ถ้ามีสัญลักษณ์ เป็น - กับ + สลับกัน
...
```text
ช่วยในการให้คำแนะนำเกี่ยวกับโค้ด
