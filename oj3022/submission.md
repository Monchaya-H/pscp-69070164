...
```text
โจทย์นี้ต้องการเปลี่ยนอุณหภูมิ
Input-1:ค่าอุณหภูมิ 
Input-2:เป็นหน่วยของอุณหภูมิ ปัจจุบัน (C, F, K, R )
Input-3:เป็นหน่วยของอุณหภูมิที่ต้องการเปลี่ยน (C, F, K, R )
Output:เป็นอุณหภูมิ 
Constraints: Outputต้องแสดงเป็นทศนิยม 2 ตำแหน่ง
...
```text
Step 1: ดูTestcases
Step 2: ทำif else ให้ส่วนนี้เป็นให้เป็นการแปลงหน่วยต้น
Step 3: และทำif elseอีกก้อนนึง เป็นการแปลงเป็นCelsius
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ การแยกส่วนif else ระหว่างการหาค่าธรรมดา กับการหาให้เป็นเซลเซียสหมด เข้าใจง่ายดี เพราะบางTestcasesต้องการหา เซลเซียส หรือไม่ก็หาหน่วยของอุณหภูมิ แต่การหาเซลเซียสต้องสลับเครื่องหมาย เช่น + เป็น- จาก *เป็น /
...
```text
หาค่าของC แต่มีมากกว่า 1000 องศา
...
```text
ช่วยแนะนำโค้ดและอธิบายโจทย์ที่ไม่เข้าใจ
