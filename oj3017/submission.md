...
```text
โจทย์นี้ต้องการเราคำนวณผลรวมราคาอาหารทั้งหมดกับค่าบริการและ VAT 7%ที่โจทย์กำหนดให้
Input:จำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่ม(จำนวนเต็ม)
Output:เป็นราคาอาหารทั้งหมดที่รวมค่าบริการ และ VAT 7% เป็นราคาที่ลูกค้าต้องจ่าย
Constraints: กำหนดค่าบริการไว้ 10% ของราคาอาหารและเครื่องดื่ม และoutput ต้องให้แสดงเป็นจำนวนจริงทศนิยม 2 หลัก
...
```text
Step 1: หาวิธีการคำนวณราคารวมค่าอาหารกับค่าบริการและvat7%
Step 2: ถ้าราคาอาหารเมื่อรวมกับค่าบริการอยู่น้อยกว่า 50 ราคารวมแค่อาหารจะบวก50เพิ่ม หรือ ถ้าราคาอาหารและค่าบริการเกิน1000ราคาอาหารจะบวก1000เพิ่มไป 
Step 3: แต่ถ้าราคาอาหารเมื่อรวมกับค่าบริการ อยู่ระหว่าง 50 กับ 1000 จะคำนวณปกติไม่ต้องบวกอะไรเพิ่ม
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะ ในโจทย์กำหนดให้เริ่มคิดค่าบริการ อย่างน้อย50แต่ไม่เกิน1000 ถ้าเมื่อหาค่ารวมของค่าบริการกับราคาอาหารที่ได้น้อยกว่า 50 หรือมากกว่า 1000 จะต้องบวก50 หรือ 1000เพิ่ม แล้วค่อยหาค่าvat7%แล้วนำค่าบริการและค่าvat7%ที่หามา มารวมกับจะได้ราคาอาหารที่ต้องจ่าย
...
```text
ช่วยอธิบายโจทย์ต้องส่วนที่ไม่เข้าใจ
